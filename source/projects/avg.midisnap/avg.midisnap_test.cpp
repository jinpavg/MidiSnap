...
#include "avg.midisnap.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<avg_midisnap> an_instance;
        avg_midisnap&              my_object = an_instance;
